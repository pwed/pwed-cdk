...
```typescript
import { BastionAccessPolicy } from 'pwed-cdk-bastion'

new BastionAccessPolicy(scope: Construct, id: string, props?: BastionAccessPolicyProps)
```
...
| <code><a href="#pwed-cdk-bastion.BastionAccessPolicy.Initializer.parameter.props">props</a></code> | <code><a href="#pwed-cdk-bastion.BastionAccessPolicyProps">BastionAccessPolicyProps</a></code> | *No description.* |
...
- *Type:* <a href="#pwed-cdk-bastion.BastionAccessPolicyProps">BastionAccessPolicyProps</a>
...
BastionAccessPolicy.isConstruct(x: any)
```
...
```typescript
import { BastionPermissionSet } from 'pwed-cdk-bastion'

new BastionPermissionSet(scope: Construct, id: string, props: BastionPermissionSetProps)
```
...
| <code><a href="#pwed-cdk-bastion.BastionPermissionSet.Initializer.parameter.props">props</a></code> | <code><a href="#pwed-cdk-bastion.BastionPermissionSetProps">BastionPermissionSetProps</a></code> | *No description.* |
...
- *Type:* <a href="#pwed-cdk-bastion.BastionPermissionSetProps">BastionPermissionSetProps</a>
...
BastionPermissionSet.isConstruct(x: any)
```
...
BastionPermissionSet.isResource(construct: IConstruct)
```
...
```typescript
import { LinuxBastion } from 'pwed-cdk-bastion'

new LinuxBastion(scope: Construct, id: string, props: LinuxBastionProps)
```
...
| <code><a href="#pwed-cdk-bastion.LinuxBastion.Initializer.parameter.props">props</a></code> | <code><a href="#pwed-cdk-bastion.LinuxBastionProps">LinuxBastionProps</a></code> | *No description.* |
...
- *Type:* <a href="#pwed-cdk-bastion.LinuxBastionProps">LinuxBastionProps</a>
...
LinuxBastion.isConstruct(x: any)
```
...
LinuxBastion.isResource(construct: IConstruct)
```
...
```typescript
import { ScheduleShutdown } from 'pwed-cdk-bastion'

new ScheduleShutdown(scope: Construct, id: string, props?: ScheduleShutdownProps)
```
...
| <code><a href="#pwed-cdk-bastion.ScheduleShutdown.Initializer.parameter.props">props</a></code> | <code><a href="#pwed-cdk-bastion.ScheduleShutdownProps">ScheduleShutdownProps</a></code> | *No description.* |
...
- *Type:* <a href="#pwed-cdk-bastion.ScheduleShutdownProps">ScheduleShutdownProps</a>
...
ScheduleShutdown.isConstruct(x: any)
```
...
```typescript
import { WindowsBastion } from 'pwed-cdk-bastion'

new WindowsBastion(scope: Construct, id: string, props: WindowsBastionProps)
```
...
| <code><a href="#pwed-cdk-bastion.WindowsBastion.Initializer.parameter.props">props</a></code> | <code><a href="#pwed-cdk-bastion.WindowsBastionProps">WindowsBastionProps</a></code> | *No description.* |
...
- *Type:* <a href="#pwed-cdk-bastion.WindowsBastionProps">WindowsBastionProps</a>
...
WindowsBastion.isConstruct(x: any)
```
...
WindowsBastion.isResource(construct: IConstruct)
```
...
```typescript
import { BastionAccessPolicyProps } from 'pwed-cdk-bastion'

const bastionAccessPolicyProps: BastionAccessPolicyProps = { ... }
```
...
```typescript
import { BastionInstanceProps } from 'pwed-cdk-bastion'
...
```typescript
import { BastionPermissionSetProps } from 'pwed-cdk-bastion'

const bastionPermissionSetProps: BastionPermissionSetProps = { ... }
```
...
```typescript
import { LinuxBastionProps } from 'pwed-cdk-bastion'

const linuxBastionProps: LinuxBastionProps = { ... }
```
...
| <code><a href="#pwed-cdk-bastion.LinuxBastionProps.property.packageManager">packageManager</a></code> | <code><a href="#pwed-cdk-bastion.LinuxPackageManager">LinuxPackageManager</a></code> | Package manager used for installing packages. |
...
- *Type:* <a href="#pwed-cdk-bastion.LinuxPackageManager">LinuxPackageManager</a>
- *Default:* dnf
...
```typescript
import { ScheduleShutdownProps } from 'pwed-cdk-bastion'

const scheduleShutdownProps: ScheduleShutdownProps = { ... }
```
...
```typescript
import { SecurityTagable } from 'pwed-cdk-bastion'

const securityTagable: SecurityTagable = { ... }
```
...
```typescript
import { WindowsBastionProps } from 'pwed-cdk-bastion'

const windowsBastionProps: WindowsBastionProps = { ... }
```
